package br.com.api.gestao_cursos.modules.auth.useCaseService;

import br.com.api.gestao_cursos.modules.auth.dto.CreateAuthRequestDto;
import br.com.api.gestao_cursos.modules.auth.dto.CreateAuthResponseDto;
import br.com.api.gestao_cursos.modules.users.entities.RoleUser;
import br.com.api.gestao_cursos.modules.users.entities.UserEntity;
import br.com.api.gestao_cursos.modules.users.repository.UserRepository;
...
public class CreateAuthUseCase {
    ...
    public CreateAuthResponseDto create(CreateAuthRequestDto createAuthRequestDto, RoleUser roleUser) throws UserPrincipalNotFoundException {
        ...
        var expiresIn = issueAt.plus(3, ChronoUnit.MINUTES);
